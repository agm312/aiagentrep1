      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="bg-gray-800 rounded-lg shadow-lg p-8 border border-gray-700">
          ...
          <div className="prose prose-invert max-w-none mb-12 text-gray-300">
            ...
            <p className="mb-6">At <strong>AI Agent Rep</strong> (<a href="http://www.aiagentrep.com" className="text-blue-400 hover:text-blue-300 underline">www.aiagentrep.com</a>), your privacy is important to us. This Privacy Policy explains how we collect, use, and protect your information when you interact with our website, services, and tools.</p>
            <hr className="my-8 border-gray-600" />
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">1. Information We Collect</h2>
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">2. How We Use Your Information</h2>
            <ul className="mb-6 list-disc pl-6">
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">3. Sharing Your Information</h2>
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">4. Cookies & Tracking Technologies</h2>
            <ul className="mb-6 list-disc pl-6">
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">5. Data Security</h2>
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">6. Your Rights</h2>
            <ul className="mb-6 list-disc pl-6">
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">7. Data Retention</h2>
            <ul className="mb-6 list-disc pl-6">
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">8. Children's Privacy</h2>
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">9. Changes to This Policy</h2>
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">10. Contact Us</h2>
            <p className="mb-6">If you have questions or concerns about this Privacy Policy, please contact us: <a href="mailto:info@aiagentrep.com" className="text-blue-400 hover:text-blue-300 underline">info@aiagentrep.com</a></p>
          </div>
        </div>
      </section>
    </Layout>
