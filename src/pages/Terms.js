...
export default function Terms() {
  return (
    <section className="min-h-screen bg-dark-950 py-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      <div className="bg-white rounded-lg shadow-lg p-8">
        <h1 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">Terms & Conditions</h1>
        <div className="prose prose-blue max-w-none mb-12 text-gray-700">
          <p className="mb-6"><strong>Effective Date: July 11, 2025</strong></p>
          <p className="mb-6">Welcome to <strong>AI Agent Rep</strong> (<a href="http://www.aiagentrep.com" className="text-blue-600 hover:text-blue-800 underline">www.aiagentrep.com</a>), by accessing or using our website and services, you agree to comply with and be bound by the following terms and conditions. Please read them carefully before using our site or subscribing to any of our services.</p>
          <hr className="my-8" />
          <h2 className="mt-10 mb-4 text-xl font-semibold text-gray-900">1. Overview</h2>
          ...
          <h2 className="mt-10 mb-4 text-xl font-semibold text-gray-900">2. Eligibility</h2>
          ...
          <h2 className="mt-10 mb-4 text-xl font-semibold text-gray-900">3. Account Registration</h2>
          ...
          <h2 className="mt-10 mb-4 text-xl font-semibold text-gray-900">4. Subscription & Payment</h2>
          ...
          <h2 className="mt-10 mb-4 text-xl font-semibold text-gray-900">5. Use of Services</h2>
          ...
          <h2 className="mt-10 mb-4 text-xl font-semibold text-gray-900">6. AI Limitations</h2>
          ...
          <h2 className="mt-10 mb-4 text-xl font-semibold text-gray-900">7. Intellectual Property</h2>
          ...
          <h2 className="mt-10 mb-4 text-xl font-semibold text-gray-900">8. Confidentiality</h2>
          ...
          <h2 className="mt-10 mb-4 text-xl font-semibold text-gray-900">9. Cancellation & Refunds</h2>
          ...
          <h2 className="mt-10 mb-4 text-xl font-semibold text-gray-900">10. Termination</h2>
          ...
          <h2 className="mt-10 mb-4 text-xl font-semibold text-gray-900">11. Disclaimers</h2>
          ...
          <h2 className="mt-10 mb-4 text-xl font-semibold text-gray-900">12. Limitation of Liability</h2>
          ...
          <h2 className="mt-10 mb-4 text-xl font-semibold text-gray-900">13. Changes to Terms</h2>
          ...
          <h2 className="mt-10 mb-4 text-xl font-semibold text-gray-900">14. Governing Law</h2>
          ...
          <h2 className="mt-10 mb-4 text-xl font-semibold text-gray-900">15. Contact Us</h2>
