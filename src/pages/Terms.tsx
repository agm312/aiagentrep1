    ...
    <Layout>
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="bg-gray-800 rounded-lg shadow-lg p-8 border border-gray-700">
          <h1 className="text-3xl md:text-4xl font-bold mb-6 text-white">Terms & Conditions</h1>
          <div className="prose prose-invert max-w-none mb-12 text-gray-300">
            ...
            <p className="mb-6">Welcome to <strong>AI Agent Rep</strong> (<a href="http://www.aiagentrep.com" className="text-blue-400 hover:text-blue-300 underline">www.aiagentrep.com</a>), by accessing or using our website and services, you agree to comply with and be bound by the following terms and conditions. Please read them carefully before using our site or subscribing to any of our services.</p>
            <hr className="my-8 border-gray-600" />
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">1. Overview</h2>
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">2. Eligibility</h2>
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">3. Account Registration</h2>
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">4. Subscription & Payment</h2>
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">5. Use of Services</h2>
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">6. AI Limitations</h2>
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">7. Intellectual Property</h2>
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">8. Confidentiality</h2>
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">9. Cancellation & Refunds</h2>
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">10. Termination</h2>
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">11. Disclaimers</h2>
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">12. Limitation of Liability</h2>
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">13. Changes to Terms</h2>
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">14. Governing Law</h2>
            ...
            <h2 className="mt-10 mb-4 text-xl font-semibold text-white">15. Contact Us</h2>
            <p className="mb-6">If you have questions or concerns about these Terms & Conditions, please contact us: <a href="mailto:info@aiagentrep.com" className="text-blue-400 hover:text-blue-300 underline">info@aiagentrep.com</a></p>
          </div>
        </div>
      </section>
    </Layout>
